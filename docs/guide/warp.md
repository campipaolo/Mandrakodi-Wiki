...
??? info "Localsend"
    ...
    * Sito web: <a href="https://localsend.org/it/download" target="_blank">Loalsend    Windows/macOS/Linux/Android/AndroidTv/iOS</a><br>
    * Utenti **Firestick**: provare una o più fonti<br>
      F-Droid: <a href="https://f-droid.org/packages/org.localsend.localsend_app/" target="_blank">scaricare apk versione "armeabi-v7a"</a><br>
      Github: <a href="https://github.com/localsend/localsend/releases/latest" target="_blank">scaricare apk "LocalSend-x.xx.x-android-arm32v7.apk"</a><br>
