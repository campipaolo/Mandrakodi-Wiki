[:material-home: Torna alla Home](../index.md){.md-button .md-button--primary} [:material-arrow-right-bold: Assistenza](..//ask_help.md){ .md-button .md-button--primary }
...
??? info "2) Addon Under Maintenance"
    ...
    **Soluzione:** Attendere il ripristino dei servizi.

??? info "3) Non è stato possibile contattare la sorgente. L’addon potrebbe non essere aggiornato"
    **Motivo:** MandraKodi non riesce a raggiungere la pagina degli aggiornamenti.  
...
??? info "4) Con i DNS attualmente impostati, **x.x.x.x - x.x.x.x**, potresti avere problemi a recuperare i link da alcuni siti"
    ...
    **Soluzione:** Modificare i DNS sul **router**, se possibile. In alternativa, modificarli sul device dove è installato Kodi (in questa Wiki: *Guide >>> DNS*).
